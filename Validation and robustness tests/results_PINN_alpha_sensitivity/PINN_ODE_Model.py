...
def run_all_sheets(
    ...
    summary_csv = os.path.join(output_dir, "summary_pinn.csv")
...
if __name__ == "__main__":
    run_all_sheets(
        ...
        output_dir="results_PINN_alpha_0.7000", # Folder for saving results
        ...
        alpha = 0.7,                   # Weight assigned to the physics-loss contribution
