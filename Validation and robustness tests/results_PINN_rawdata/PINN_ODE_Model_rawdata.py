...
def run_all_sheets(
    ...
    for sheet in sheet_names:
        ...
        preprocess_series_csv_path = os.path.join(output_dir, f"{sheet_str}_preprocess_series_rawdata.csv")
        ...
        pred_csv_path = os.path.join(output_dir, f"{sheet_str}_PINN_prediction_rawdata.csv")
        ...
        pdf_path = os.path.join(output_dir, f"{sheet_str}_PINN_report_rawdata.pdf")
        csv_table_path = os.path.join(output_dir, f"{sheet_str}_stats_table_rawdata.csv")
    ...
    summary_csv = os.path.join(output_dir, "summary_pinn_rawdata.csv")
...
if __name__ == "__main__":
    run_all_sheets(
        excel_path="data.xlsx",          # Original observed data
        output_dir="results_PINN_rawdata", # Folder for saving results
